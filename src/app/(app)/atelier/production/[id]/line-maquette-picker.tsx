...
export interface MaquetteFile extends AttachableMediaFile {
  /** URL signée (1h) vers Supabase Storage, ou null si le fichier n'a pas de copie exploitable pour l'aperçu (voir src/lib/media/preview.ts). */
    ...
    <div className="space-y-1.5">
      <div>
        ...
        <p className="text-[11px] text-foreground-muted">
          Simulation du rendu, jointe à cet article — cliquez sur une vignette pour l&apos;ouvrir en grand. Imprimée telle
          quelle dans le PDF de l&apos;ODF.
        </p>
      </div>
      {attached.length === 0 ? (
