...
-- Doit s'exécuter AVANT le drop column odf_id plus bas : ces policies (posées
-- par 0010) référencent encore odf_id tant qu'elles n'ont pas été recréées,
-- ce qui bloque le drop (SQLSTATE 2BP01) si l'ordre est inversé.
